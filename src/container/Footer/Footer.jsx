    ...
    return(
        ...
        <div className='app__footer-cards'>
            <div className='app__footer-card'>
                ...
                <a href="mailto:danieldovals@gmail.com" className='p-text'>hello@danieldoval.com</a>
            </div>
            <div className='app__footer-card'>
                <img src={images.mobile} alt="mobile" />
                <a href="tel: +57 (301) 288 27 25" className='p-text'>+57 (301) 288 27 25</a>
            </div>
        </div>
        ...
        : <div>
            <h3 className='head-text'>Gracias por comunicarte conmigo</h3>
        </div>}
        </>
    );
}
